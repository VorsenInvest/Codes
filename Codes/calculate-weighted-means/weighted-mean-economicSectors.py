...
try:
    ...
    with connection.cursor() as cursor:
        ...
        cursor.execute("DELETE FROM weighted_economicSectors;")
        cursor.execute("ALTER TABLE weighted_economicSectors AUTO_INCREMENT = 1;")
        ...
        insert_query = f"""
        INSERT INTO weighted_economicSectors ({", ".join(insert_columns)})
        ...
        connection.commit()
        print("Data successfully processed and inserted/updated into 'weighted_seconomicSectors'.")
